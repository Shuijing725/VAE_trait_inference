...
# the class for a car, defined its contour & state
class Car:
    ...
    def __init__(self, idx, length, width, color, max_accel, max_speed, max_rotation, expose_level):
        ...
        self.init_position = None # the initial position of this car
    ...
    def set_init_position(self, x_2):
        assert x_2.shape == (2,)
        self.init_position = np.array(x_2)
