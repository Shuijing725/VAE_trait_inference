...
from rl.shmem_vec_env import ShmemVecEnv
...
def make_vec_envs(env_name,
    ...
    if wrap_pytorch:
        ...
        # wrap the env if we need a pretext network to infer the latent state for rl observation
        envs = VecPretextNormalize(envs, config=config)
