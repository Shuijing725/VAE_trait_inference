...
class Config(object):
    ...
    training.output_dir = 'data/con40/public_morton_rl_oldNorm1'  # the saving directory for train.py
    ...
    training.pretext_model_path = 'data_sl/models/public_morton/checkpoints/995.pt'
    ...
    pretext.model_load_dir = 'data_sl/models/public_ours/checkpoints/995.pt'  # path of the checkpoint we resume from

    # for data collection
    # how many traj to collect for each data file
    pretext.num_data_per_file = 4600
    # the directory that the dataset is saved in
    pretext.data_save_dir = 'data_sl/data/public_dataset_minLen5'
    pretext.num_steps = 20  # number of steps per trajectory

    # for VAE training
    # where are we loading the data from
    pretext.data_load_dir = 'data_sl/data/public_dataset_minLen5'
    pretext.lr = 5e-4 # pretext learning rate
    pretext.epoch_num = 500 # 1000 # number of epochs for pretext task
    ...
    pretext.model_save_dir = 'data_sl/models/public_ours_minLen5' # the directory for saving model
