...
class Config(object):
    ...
    training.output_dir = 'data/con40/public_ours_rl_oldNorm'  # the saving directory for train.py
    ...
    training.pretext_model_path = 'data_sl/models/public_ours/checkpoints/995.pt'
